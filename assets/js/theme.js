...
function add3DEffects() {
    ...
    // Add 3D hover effects to feature cards
    const featureCards = document.querySelectorAll('.feature-wrap');
    ...
    // Add 3D effects to feature items
...
function initScrollDissolveEffects() {
    ...
    // Initial setup - hide all sections except the first visible one
    ...
    sections.forEach((section, index) => {
        if (index > 0) { // Skip the first section which is already visible
